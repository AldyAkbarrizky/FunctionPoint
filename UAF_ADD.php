<?php
    if(isset($_POST["jenis_FP"])) {
        $jenis_FP = $_POST["jenis_FP"];
    } else {
    ...
    <div class="container-fluid fill-height" style="background-color: #AAA">
        <div id="main-content-uaf" class="main-content">
            <div class="row">
                <div class="main-title">
                    ...
                    <div style="inline-block !important">
                        <strong>Menghitung Nilai UAF ADD</strong>
            ...
            <form method="post" action="ADD_Count.php">
                <div class="row">
                    <div class="col-auto">
                        <input type="number" name="jml-func" id="jml-func" class="form-control black-input" placeholder="Jumlah Fitur ADD">
                    </div>
                    <div class="col-auto">
