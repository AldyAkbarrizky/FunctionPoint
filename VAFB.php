...
<body>
    <div class="container-fluid fill-height" style="background-color: #AAA">
        <div id="main-content-vaf" class="main-content">
            <div class="row">
                <div class="main-title">
                    ...
                    <div style="inline-block !important">
                        <strong>Menghitung Nilai VAFB</strong>
                        <i class="bi bi-info-circle text-primary" style="margin-left: 5px; cursor:pointer" data-bs-toggle="modal" data-bs-target="#infoVAF"></i>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <form action="VAFB_Count.php" method="post">
                <div class="row">
                    <div class="col-10">
                        <span>Apakah sistem membutuhkan fitur backup & restore yang mumpuni?</span>
                    </div>
                    <div class="col-2">
                        <input type="number" min="0" max="5" value="0" class="form-control form-control-sm black-input" name="char[]" placeholder="Bobot">
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-10">
                        <span>Apakah komunikasi data spesialis dibutuhkan untuk melakukan transfer data?</span>
                    </div>
                    <div class="col-2">
                        <input type="number" min="0" max="5" value="0" class="form-control form-control-sm black-input" name="char[]" placeholder="Bobot">
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-10">
                        <span>Apakah terdapat fungsi proses terdistribusi?</span>
                    </div>
                    <div class="col-2">
                        <input type="number" min="0" max="5" value="0" class="form-control form-control-sm black-input" name="char[]" placeholder="Bobot">
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-10">
                        <span>Apakah performa sistem kritikal?</span>
                    </div>
                    <div class="col-2">
                        <input type="number" min="0" max="5" value="0" class="form-control form-control-sm black-input" name="char[]" placeholder="Bobot">
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-10">
                        <span>Apakah sistem akan bekerja pada lingkungan dimana banyak operasi yang dikerjakan?</span>
                    </div>
                    <div class="col-2">
                        <input type="number" min="0" max="5" value="0" class="form-control form-control-sm black-input" name="char[]" placeholder="Bobot">
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-10">
                        <span>Apakah sistem membutuhkan data entry secara online?</span>
                    </div>
                    <div class="col-2">
                        <input type="number" min="0" max="5" value="0" class="form-control form-control-sm black-input" name="char[]" placeholder="Bobot">
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-10">
                        <span>Apakah data tersebut membutuhkan inputan yang membutuhkan banyak tampilan?</span>
                    </div>
                    <div class="col-2">
                        <input type="number" min="0" max="5" value="0" class="form-control form-control-sm black-input" name="char[]" placeholder="Bobot">
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-10">
                        <span>Apakah ILF pada sistem diupdate secara online?</span>
                    </div>
                    <div class="col-2">
                        <input type="number" min="0" max="5" value="0" class="form-control form-control-sm black-input" name="char[]" placeholder="Bobot">
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-10">
                        <span>Apakah input, output, files, atau kebutuhan sistem terbilang kompleks?</span>
                    </div>
                    <div class="col-2">
                        <input type="number" min="0" max="5" value="0" class="form-control form-control-sm black-input" name="char[]" placeholder="Bobot">
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-10">
                        <span>Apakah proses internal pada sistem terbilang kompleks?</span>
                    </div>
                    <div class="col-2">
                        <input type="number" min="0" max="5" value="0" class="form-control form-control-sm black-input" name="char[]" placeholder="Bobot">
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-10">
                        <span>Apakah kode dari sistem didesain untuk digunakan kembali?</span>
                    </div>
                    <div class="col-2">
                        <input type="number" min="0" max="5" value="0" class="form-control form-control-sm black-input" name="char[]" placeholder="Bobot">
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-10">
                        <span>Apakah konversi dan instalasi sistem termasuk ke dalam desain?</span>
                    </div>
                    <div class="col-2">
                        <input type="number" min="0" max="5" value="0" class="form-control form-control-sm black-input" name="char[]" placeholder="Bobot">
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-10">
                        <span>Apakah sistem didesain untuk diinstal pada banyak organisasi?</span>
                    </div>
                    <div class="col-2">
                        <input type="number" min="0" max="5" value="0" class="form-control form-control-sm black-input" name="char[]" placeholder="Bobot">
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-10">
                        <span>Apakah sistem didesain untuk memfasilitasi kemudahan penggunaan untuk user?</span>
                    </div>
                    <div class="col-2">
                        <input type="number" min="0" max="5" value="0" class="form-control form-control-sm black-input" name="char[]" placeholder="Bobot">
                    </div>
    ...
    <script>
        ...
        $("#add-button").click(function () {
            ...
            document.getElementById("jml-func").disabled = true;
            var jen_FP = "AFP";
            var jumlah_fungsi = document.getElementById("jml-func").value;
            for (let i = 1; i <= jumlah_fungsi; i++) {
                $("#fitur-container").append('<button class="tablink" onclick="openPage(\'Fitur'+i+'\', this)">Fitur ' + i + '</button>');
            }
            for (let i = 1; i <= jumlah_fungsi; i++) {
                $("#fitur-container").append(
                    '<div id="Fitur'+i+'" class="tabcontent">' +
                        '<h5>Detail Fitur ' + i + '</h3>' +
                        '<form method="post" action="ADD_Count.php">' +
        ...
        $("#reset-button").click(function () {
            ...
            document.getElementById("jml-func").disabled = false;
