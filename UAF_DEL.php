...
<body>
    <div class="container-fluid fill-height" style="background-color: #AAA">
        <div id="main-content-uaf" class="main-content">
            <div class="row">
                <div class="main-title">
                    ...
                    <div style="inline-block !important">
                        <strong>Menghitung Nilai UAF DEL</strong>
            ...
            <form method="post" action="DEL_Count.php">
                <div class="row">
                    <div class="col-auto">
                        <input type="number" name="jml-func" id="jml-func" class="form-control black-input" placeholder="Jumlah Fitur DEL">
                    </div>
                    <div class="col-auto">
