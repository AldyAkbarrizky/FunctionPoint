<?php
    ...
    if(!isset($_SESSION["jen_FP"])){ //if login in session is not set
        ...
        if($jenis_FP == "DFP" || $jenis_FP == "AFP") {
            $total_FP = $_SESSION["UAF_total"] * $_SESSION["VAF_total"];
        } else if($jenis_FP == "EFP") {
            $total_FP = (($_SESSION["UAF_ADD"] + $_SESSION["UAF_CHGA"] + $_SESSION["UAF_CFP"]) * $_SESSION["VAF_VAFA"]) + ($_SESSION["UAF_DEL"] * $_SESSION["VAF_VAFB"]);
        }
    }
?>
<!DOCTYPE html>
...
<body>
    <div class="container-fluid fill-height" style="background-color: #AAA">
        <div id="main-content-total" class="main-content">
            <div class="row">
