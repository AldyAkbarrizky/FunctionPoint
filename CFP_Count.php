...
$total_UAF_CFP = $total_EI + $total_EO + $total_EQ + $total_ILF + $total_EIF;

session_start();
$_SESSION["jen_FP"] = $_POST["jenis_FP"];
$_SESSION["UAF_CFP"] = $total_UAF_CFP;

if($_POST["jenis_FP"] == "DFP") {
    $_SESSION["UAF_total"] = $_SESSION["UAF_ADD"] + $_SESSION["UAF_CFP"];
    header("Location: VAF.php");
} else {
    header("Location: UAF_DEL.php");
}
